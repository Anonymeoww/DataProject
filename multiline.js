...
function drawMultiLine(current_year){
    ...
    // Load data
    d3v5.json("positions.json").then(function (dataset) {
        var full_data = dataset;
        var first_of_year = dataset[current_year][Object.keys(dataset[current_year])[0]];
    ...
    function createLines(dataset){
        ...
        function updateLines(current_year, artist) {
            ...
            if (artist === "first"){
                data = full_data[current_year][Object.keys(full_data[current_year])[0]]
            }
            else{
                data = full_data[current_year][artist]
            }

            d3v5.selectAll('.line-group')
              .data(data).enter()
              .append('g')
              .attr('class', 'line-group')
              .on("mouseover", function(d, i) {
        ...
        createLines.updateLines = updateLines;
    }
}
